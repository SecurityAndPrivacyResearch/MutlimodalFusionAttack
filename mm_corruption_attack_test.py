...
from mm_corruption_attack_inference import *
...
def main(args):
    ...
    data_loader = get_loader(
        ...
        input_vqa_valid='valid_mm_corruption_attack_full.npy',
    ...
    for batch_idx, batch_sample in enumerate(data_loader['valid']):
        ...
        question_ids = batch_sample['question_ids']
        questions = batch_sample['questions']
        labels = batch_sample['answers_label']
        multi_choices = batch_sample['answers_multi_choice']  # not tensor, list.

        with torch.set_grad_enabled(True):

            attack(args, model, image, questions, labels, question_ids, image_name) 
            #infer(args, model)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', type=str, default='path_to/datasets/VQA',
                        help='input directory for visual question answering.')

    parser.add_argument('--log_dir', type=str, default='./logs',
                        help='directory for logs.')

    parser.add_argument('--model_dir', type=str, default='path_to/datasets/VQA/models',
